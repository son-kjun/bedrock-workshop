...
이 예제에서는 LangChain을 사용하지 않고 Boto3를 사용하여 직접 챗봇을 구축합니다. LangChain을 사용하여 구축한 챗봇의 예는 Basic Chatbot 또는 RAG Chatbot 랩에서 확인하실 수 있습니다. 여기서는 Anthropic Claude Messages API 
를 사용하겠습니다.
